...
namespace WalletKeeper.Domain.Repositories
{
	...
	{
		Task<Product[]> GetAsync(Guid userID, CancellationToken cancellationToken = default);

		Task<Product> GetAsync(Int32 id, Guid userID, CancellationToken cancellationToken = default);
